class worker::php()
{
 package { [ 'php5', 'php5-mysql', 'php5-tidy', 'php5-gd', 'php-pear', 'php5-apcu', 'php5-curl', 'php5-dev', 'php5-json', 'php5-mcrypt', 'php5-readline', 'php5-redis', 'php5-xdebug', 'pkg-php-tools', 'phpunit', 'php5-gearman' ]:
  ensure => 'installed',
 } ->
